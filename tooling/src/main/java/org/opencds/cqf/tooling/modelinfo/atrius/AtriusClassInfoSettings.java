...
class AtriusClassInfoSettings extends ClassInfoSettings {

    public AtriusClassInfoSettings() {
        this.modelName = "Atrius";
        this.modelPrefix = "Atrius";
        ...
        this.primaryCodePath = new HashMap<String, String>() {
            {
                ...
                put("CarePlanAssessPlan", "category");
                ...
                put("Coverage", "type");
                put("Device", "type");
                put("DeviceProhibited", "code");
                put("DeviceRequested", "code");
                ...
                put("ImmunizationDone", "vaccineCode");
                ...
                put("MedicationProhibited", "medication");
                put("MedicationRequested", "medication");
                put("MedicationRequest", "medication");
                put("MedicationStatement", "medication");
                put("NutritionOrder", "oralDiet.type");
